      ...
      <div className="mx-auto w-full max-w-300 space-y-12">
        ...
        <SectionWrapper title="So sánh nhận định" subtitle="Đặt hai góc nhìn cạnh nhau để thấy rõ: Mạng xã hội hỗ trợ dân chủ nhưng không phải bản chất của dân chủ xã hội chủ nghĩa.">
          <div className="relative grid grid-cols-1 items-start gap-8 md:grid-cols-2">
            ...
            <details open className="chapter-dropdown self-start rounded-2xl border border-blue-300/30 bg-blue-950/25 p-5">
              <summary className="chapter-dropdown-summary flex cursor-pointer list-none items-start justify-between gap-3">
                ...
                <ChevronDown className="chapter-dropdown-chevron mt-1 h-5 w-5 shrink-0 text-blue-200" />
              </summary>

              <div className="chapter-dropdown-body">
                <div className="chapter-dropdown-content mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-1">
            ...
            <details open className="chapter-dropdown self-start rounded-2xl border border-red-300/30 bg-red-950/20 p-5">
              <summary className="chapter-dropdown-summary flex cursor-pointer list-none items-start justify-between gap-3">
                <div className="flex items-start gap-3">
                ...
                <ChevronDown className="chapter-dropdown-chevron mt-1 h-5 w-5 shrink-0 text-red-200" />
              </summary>

              <div className="chapter-dropdown-body">
                <div className="chapter-dropdown-content mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-2">
